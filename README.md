...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/dominodatalab-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/dominodatalab-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add dominodatalab
# for installing globally
pixi global install dominodatalab
```
...
It is possible to list all of the versions of `dominodatalab` available on your platform:
...
```
pixi search dominodatalab --channel conda-forge
```
